...
.markdown-answer {
  ...
  font-size: var(--tutor-font-size, 15px);
  line-height: 1.82;
...
.markdown-answer :deep(h1) {
  font-size: calc(var(--tutor-font-size, 15px) + 4px);
}

.markdown-answer :deep(h2) {
  border-bottom: 1px solid var(--border-subtle);
  padding-bottom: 7px;
  font-size: calc(var(--tutor-font-size, 15px) + 3px);
}
...
.markdown-answer :deep(h4) {
  font-size: calc(var(--tutor-font-size, 15px) + 1px);
}
