...
| F-13 | evidence_ref cannot trace to canonical_paper.md-derived block | P0 | BLOCK | DOC_DESIGNED / NOT_IMPLEMENTED |
| F-14 | formula_card missing formula_origin / formula_ocr_status | P0 | BLOCK | DOC_DESIGNED / NOT_IMPLEMENTED |
| F-15 | ocr_latex / reconstructed / unknown marked as original or high-confidence | P0 | BLOCK | DOC_DESIGNED / NOT_IMPLEMENTED |
| F-16 | canonicalization_status=blocked but user-facing card exists | P0 | BLOCK | DOC_DESIGNED / NOT_IMPLEMENTED |
...
- F-13 到 F-16 canonical/formula provenance audit 为 DOC_DESIGNED / NOT_IMPLEMENTED
- Formula Source Audit full origin chain 为 DOC_DESIGNED / NOT_IMPLEMENTED
...
| ID | 条件 | severity | effect | 状态 |
|----|------|----------|--------|------|
| FSA-1 | high-confidence formula_card must have `formula_origin=source_latex` and valid evidence_ref | P0 | BLOCK | DOC_DESIGNED / NOT_IMPLEMENTED |
| FSA-2 | `parser_latex` explanation must keep parser warning and cannot claim original source | P1 | WARNING | DOC_DESIGNED / NOT_IMPLEMENTED |
| FSA-3 | `ocr_latex` explanation must include OCR warning and confidence cap | P0 | BLOCK | DOC_DESIGNED / NOT_IMPLEMENTED |
