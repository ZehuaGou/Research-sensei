...
| M3 API/UI | `src/researchsensei/web/app_factory.py`, `src/researchsensei/web/routers/`, `src/researchsensei/web/services/`, `frontend/src/api/`, workspace composables/components | `docs/development/M3_FRONTEND_RENDER.md` |
