...
def test_m1_docs_state_primary_parser_and_boundaries() -> None:
...
def test_status_doc_no_longer_marks_m1_core_as_not_implemented() -> None:
    status = Path("docs/STATUS.md").read_text(encoding="utf-8")

    forbidden_rows = [
        "MinerU25ProAdapter (PRIMARY) | not implemented",
        "OllamaSectionRefiner | not implemented",
        "RuleBasedStructureRefiner | not implemented",
        "M1 Quality Gate | not implemented",
    ]
