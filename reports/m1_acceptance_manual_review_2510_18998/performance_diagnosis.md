...
MinerU2.5-Pro is running on GPU (NVIDIA GeForce RTX 4060 Laptop GPU) via the `transformers` backend. Each page takes ~179 seconds, which exceeds the 120s/page warning threshold.
