# Public M1 Verify Report: TranAD: Deep Transformer Networks for Anomaly Detection in Multivariate Time Series Data
...
- bbox_count: 129
- section_distribution: {'Unknown': 41, 'Abstract': 19, 'Method': 2026, 'Introduction': 19, 'Experiments': 515, 'Related Work': 6, 'Appendix': 50, 'Conclusion': 13, 'References': 23}
...
- core_formula_coverage: {'TranAD': 'FOUND_RAW_TEXT', 'transformer': 'FOUND_RAW_TEXT', 'anomaly score': 'MISSING: not present in parsed formula blocks or copied parser text', 'self-conditioning': 'FOUND_RAW_TEXT'}