# Parser Comparison: TranAD: Deep Transformer Networks for Anomaly Detection in Multivariate Time Series Data
...
| ------ | ------------: | ------------: | ------------: | ----------------: | --------------: | --------------: | ----------------------: | -----------------: | -------- | ------ |
| pymupdf | 0.000 | 0 | 0 | 0 | 0.000 | 0 | 129 | 0.000 | YES | generated_from_acceptance_blocks |