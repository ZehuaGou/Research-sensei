...
| ----- | ------ | ------ | -------- | ---------------- | -------: | ----: | -------: | --------: | -------- |
| paper_1 | marker_document | DEGRADED | True | True | 54 | 41 | 13 | 2 | p(x|z)=FOUND_LATEX; p(xt|zt=0)=FOUND_LATEX; p(zt+1|zt)=FOUND_LATEX; ELBO=MISSING: not present in parsed formula blocks or copied parser text |
| paper_2 | pymupdf | DEGRADED | False | False | 26 | 0 | 26 | 3 | Gumbel-softmax=FOUND_RAW_TEXT; Attention(Q,K,V)=FOUND_RAW_TEXT; MultiHead(Q,K,V)=FOUND_RAW_TEXT; Influence Propagation=FOUND_TEXT |
| paper_3 | pymupdf | PASS | True | True | 9 | 9 | 0 | 0 | Prior-Association=FOUND_TEXT; Series-Association=FOUND_TEXT; AssDis(P,S;X)=FOUND_LATEX; AnomalyScore=FOUND_TEXT |
| paper_4_unseen | mineru25pro | PASS | True | True | 11 | 11 | 0 | 0 | Gated memory=FOUND_TEXT; anomaly score=FOUND_TEXT; bi-dimensional deviation=FOUND_TEXT; K-means=FOUND_TEXT |
| paper_5_unseen | pymupdf | DEGRADED | False | False | 129 | 0 | 129 | 3 | TranAD=FOUND_RAW_TEXT; transformer=FOUND_RAW_TEXT; anomaly score=MISSING: not present in parsed formula blocks or copied parser text; self-conditioning=FOUND_RAW_TEXT |
