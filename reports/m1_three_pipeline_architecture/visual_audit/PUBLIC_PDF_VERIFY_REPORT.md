...
| 26 | paper_3 | formula_001 | 2 | Introduction | Y | Y | `I(X,Y) = \sum_{x \in X} \sum_{...` | `I(X,Y) = \sum_{x \in X} \sum_{...` | Y | parser_latex | Y | Y | N |
...
| 35 | paper_3 | formula_010 | 4 | Method | Y | Y | `\begin{aligned} \mathbf{Y}_{\t...` | `\begin{aligned} \mathbf{Y}_{\t...` | Y | parser_latex | Y | Y | N |
| 36 | paper_3 | formula_011 | 4 | Method | Y | Y | `\mathcal{L}_{aux} = \/\text{sh...` | `\mathcal{L}_{aux} = \/\text{sh...` | Y | parser_latex | Y | Y | N |
| 37 | paper_3 | formula_012 | 5 | Method | Y | Y | `\begin{aligned} \mathbf{Y}_{\t...` | `\begin{aligned} \mathbf{Y}_{\t...` | Y | parser_latex | N | Y | N |
| 38 | paper_3 | formula_013 | 5 | Method | Y | Y | `\mathcal{L}_{\text{sta}} = \/\...` | `\mathcal{L}_{\text{sta}} = \/\...` | Y | parser_latex | Y | Y | N |
| 39 | paper_3 | formula_014 | 5 | Method | Y | Y | `I_{\text{InfoNCE}} = \mathbb{E...` | `I_{\text{InfoNCE}} = \mathbb{E...` | Y | parser_latex | Y | Y | N |
| 40 | paper_3 | formula_015 | 5 | Method | Y | Y | `f_{\theta}(\mathbf{Y}, \mathbf...` | `f_{\theta}(\mathbf{Y}, \mathbf...` | Y | parser_latex | Y | Y | N |
| 41 | paper_3 | formula_016 | 5 | Method | Y | Y | `\mathcal{L}_{\text{reg}} = \/\...` | `\mathcal{L}_{\text{reg}} = \/\...` | Y | parser_latex | Y | Y | N |
| 42 | paper_3 | formula_017 | 5 | Method | Y | Y | `\mathcal{L} = \lambda_1 \cdot ...` | `\mathcal{L} = \lambda_1 \cdot ...` | Y | parser_latex | Y | Y | N |
| 43 | paper_3 | formula_018 | 6 | Method | Y | Y | `\mathcal{AS}(\mathbf{s}_i) = -...` | `\mathcal{AS}(\mathbf{s}_i) = -...` | Y | parser_latex | Y | Y | N |
