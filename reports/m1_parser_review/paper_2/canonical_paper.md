...
parser_quality_details:
  ...
  markitdown_pdf:
    ...
    garbled_line_ratio: 0.035
    reason: Severe concatenation (152 long words)
---
...
(WADI) system [9], multiple sensing measurements such as
...
as the source node’s connections, followed by a graph attention
...
3
Fig. 1: The visualization of our proposed GTA’s architecture with l levels dilated convolution and graph convolution, 3 encoder
...
ˆ
X represent the entire normal data and data with anomalies,
...
historical n time steps of multivariate contiguous observations
...
E ⊆V × V is the set of edges, where ei,j represents the
...
node j. The neighborhood of any node i is deﬁned as N(i) =
{j ∈V|ei,j ∈E}.
4
...
[44], [45]. These discovered hidden associations are
...
control variable for any pair of nodes i and j with uni-directed
...
exists an information ﬂow from node i to node j in the graph
...
putation complexity from O(M 2) to O(1) since it requires
...
(6)
in which, h is the number of total heads. Each head is deﬁned
as:
...
two projection matrices W Q and W K. The attention now has
been as following:
...
the expected value at time t to the observed value, computing
...
2
(11)
Finally, we label a timestamp t as an anomaly if ˆy(t) exceeds a
...
niques (AE, LSTM-VAE, MAD-GAN, etc.) generally have a
...
(LSTM-VAE, OmniAnomaly, MAD-GAN) and forecasting-
...
ries. LSTM-VAE [11] combines LSTM with VAE for sequence
...
those within SWaT or WADI where any slight change that
...
performance degrades on datasets SWaT and WADI. First, we
...
<!-- formula_id: fc_1 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
However, one
L = (cid:88) logπi,j (4) mainefficiencybottleneckinself-attentionisthatthepairwise
```

<!-- formula_id: fc_2 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
QKT
Attention(Q,K,V)=Softmax( √ )V (5)
```

<!-- formula_id: fc_3 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
MultiHead(Q,K,V)=Concat(head ,··· ,head )WO
```

<!-- formula_id: fc_4 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
offbetween
head i =Attention(QW i Q,KW i K,VW i V) (7) computation efficiency and model performance, we propose
```

<!-- formula_id: fc_5 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Testing size (data with attacks) 44931 17219
i=1 Anomaly rate (%) 12.14 5.75
```

<!-- formula_id: fc_6 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
rations with 14 days under regular operation Recall= (14)
```

<!-- formula_id: fc_7 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Moreover, SMAP (Soil Moisture F1=2× (15)
```

<!-- formula_id: fc_8 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
argmax(logπi,j +gi,j)
```

<!-- formula_id: fc_9 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Attention(Q,K,V)
```

<!-- formula_id: fc_10 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Softmax( √ )
```

<!-- formula_id: fc_11 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
MultiHead(Q,K,V)
```

<!-- formula_id: fc_12 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Attention(QW i Q,KW i K,VW i V)
```

<!-- formula_id: fc_13 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
MultiHead(X(1)
```

<!-- formula_id: fc_14 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Attention(S,V)
```

<!-- formula_id: fc_15 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
ned as N(i) =
{j ∈V|ei,j ∈E}.
```

<!-- formula_id: fc_16 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
i,j
1
= 1 and πi,j
...
<!-- formula_id: fc_17 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Uniform(0, 1) and computing
g = −log(−log u). We further substitute this arg max oper-
```

<!-- formula_id: fc_18 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
zi,j
c
=
...
<!-- formula_id: fc_19 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Attention(Q, K, V) = Softmax(QKT
```

<!-- formula_id: fc_20 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
MultiHead(Q, K, V) = Concat(head1, · · · , headh)W O
```

<!-- formula_id: fc_21 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
headi = Attention(QW Q
```

<!-- formula_id: fc_22 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Attention(S, V) = Softmax(S)V
```

<!-- formula_id: fc_23 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
d2 and d = d1 + d2.
```

<!-- formula_id: fc_24 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
FN
(14)
F1 = 2 × Precision × Recall
...
<!-- formula_id: fc_25 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Softmax(QKT
√dk
)
...
<!-- formula_id: fc_26 | origin: raw_formula_text | section: Formula Blocks | page: N/A | bbox: [] | ocr_status: not_triggered | is_latex: False | confidence: 0.3 -->
```text
Attention(QW Q
i , KW K
i , VW V
