...
parser_quality_details:
  ...
  markitdown_pdf:
    ...
    spacing_quality: 1.0
    cid_token_count: 10
    formula_candidate_count: 3
    garbled_line_ratio: 0.03
    reason: Severe concatenation (193 long words)
---
...
```text
her, we make no assumptions about whether anomalies =E p(x,y) [f(x,y)]−E p(y) [logZ(y)]
```
